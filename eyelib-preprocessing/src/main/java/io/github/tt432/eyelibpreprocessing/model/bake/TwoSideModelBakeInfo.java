 ...
 * @author TT432
 */
public class TwoSideModelBakeInfo extends ModelBakeInfo<TwoSideInfoMap> {
    ...
    @Override
    public io.github.tt432.eyelibpreprocessing.model.bake.BakedModel bake(Model model, TwoSideInfoMap twoSideInfoMap) {
        Int2ObjectMap<io.github.tt432.eyelibpreprocessing.model.bake.BakedModel.BakedBone> bones = new Int2ObjectOpenHashMap<>();
        ...
        return new io.github.tt432.eyelibpreprocessing.model.bake.BakedModel(bones);
    }

    private static void collectBones(int name, Model.Bone bone, Int2ObjectMap<io.github.tt432.eyelibpreprocessing.model.bake.BakedModel.BakedBone> bones, Int2ObjectMap<TwoSideInfo> info) {
        bones.put(name, bake(bone, info));
        bone.children().forEach((s, bone1) -> collectBones(s, bone1, bones, info));
    }

    public static io.github.tt432.eyelibpreprocessing.model.bake.BakedModel.BakedBone bake(Model.Bone bone, Int2ObjectMap<TwoSideInfo> info) {
        ...
        return new io.github.tt432.eyelibpreprocessing.model.bake.BakedModel.BakedBone(
