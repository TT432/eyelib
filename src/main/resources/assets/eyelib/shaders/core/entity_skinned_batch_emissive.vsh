...
// C1 跨实体合批 compute 蒙皮（1.20.1）：rendertype_entity_translucent_emissive.vsh 的直通变体。
// 顶点已被 skin_batch.comp 蒙皮；与 entity_skinned_compute_emissive.vsh 差异仅
// TintColor/OverlayUV 由 uniform 改为逐顶点属性。
