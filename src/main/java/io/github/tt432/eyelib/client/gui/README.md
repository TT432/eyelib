...
## Current split
- `:eyelib-preprocessing` now owns the platform-free reload planning seam (`io.github.tt432.eyelibpreprocessing.manager.reload.ManagerResourceReloadPlan` + batch helpers).
