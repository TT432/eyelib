...
public class UnbakedModelPart extends SimpleUnbakedGeometry<UnbakedModelPart> {
    ...
    @Override
    protected void addQuads(@NotNull IGeometryBakingContext owner, @NotNull IModelBuilder<?> modelBuilder,
                            @NotNull ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter,
