...
- `:eyelib-preprocessing` `manager/reload/ManagerResourceReloadPlan.java`: platform-free single-file routing and texture-key planning helper used by import planner runtime wiring
- `:eyelib-preprocessing` `manager/reload/ManagerResourceBatchPlanner.java`: platform-free file collection and batch assembly helper used by import planner runtime wiring
