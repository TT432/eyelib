...
import io.github.tt432.eyelib.example.client.model.entity.ExampleExtendedRendererEntityModel;
import io.github.tt432.eyelib.example.entity.ExtendedRendererEntity;
...
public class ExampleExtendedRendererEntityRenderer extends ExtendedGeoEntityRenderer<ExtendedRendererEntity> {
    ...
    @Override
    protected void postRenderItem(PoseStack matrixStack, ItemStack item, String boneName, ExtendedRendererEntity currentEntity, Bone bone) {
    }
