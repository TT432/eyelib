...
- This is the top-level package for the library's root runtime, client, network, Molang adapters, capability, and
  behavior-related subsystems.
...
- `util/`: drained historical utility package; shared helpers now live in `:eyelib-util` under
