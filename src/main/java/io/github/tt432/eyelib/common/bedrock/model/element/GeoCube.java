...
public class GeoCube {
    ...
    public static GeoCube createFromPojoCube(CubeFile cubeFileIn, ModelProperties properties, Double boneInflate,
                                             Boolean mirror) {
        ...
        cube.mirror = cubeFileIn.getMirror();
