...
public class BakedModels {
     ...
     */
    public BakedModel bake(ModelResourceLocation modelResourceLocation, IUnbakedGeometry<?> model) {
     ...
     * 需要在 ModelManager 重载结束后可用
     */
    public BakedModel bake(ModelResourceLocation modelResourceLocation, UnbakedModel model) {
