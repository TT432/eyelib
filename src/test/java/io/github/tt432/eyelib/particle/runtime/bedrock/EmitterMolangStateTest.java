...
/** @author TT432 */
class EmitterMolangStateTest {
    @Test
    void createEmitterInheritsParentScopeAndRegistersEmitterVariables() {
        ...
        BedrockParticleEmitter emitter = runtime.createEmitter(Optional.of(parentScope), new Vector3f());
