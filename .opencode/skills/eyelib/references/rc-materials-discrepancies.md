...
| 文件 | 改动 |
|---|---|
| `eyelib-molang/.../MolangMapEntry.java` | **新建** |
| `eyelib-importer/.../BrRenderControllerEntry.java` | `materials` 字段 Map→List<MolangMapEntry> |
| `.../RenderControllerEntry.java` | 同上 + `setupModel()` 重写 |
| `eyelib-material/.../BrMaterialEntry.java` | +1行 alphatest 检查 |
| `eyelib-material/.../RenderTypeResolver.java` | +1 case 分支 |
