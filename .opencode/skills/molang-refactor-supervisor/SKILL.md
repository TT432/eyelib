...
1. Read `docs/molang/ROADMAP.md`, `docs/molang/refactor-plan/README.md`, the relevant phase plan, `MODULES.md`, and `docs/index/repo-map.md` before assigning a slice.
