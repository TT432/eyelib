...
- **节点图编辑器全版本统一 LDLib2。** ldlib1（LDLib 1.x graphprocessor 适配层）已于 2026-08-07 退役（用户决策，见 docs/decisions/0028-ldlib1-retirement.md）：1.20.1 由 TT432/LDLib2-1.20.1-Forge fork 支撑。编辑器新功能只需在 ldlib2 适配层单端实现。
