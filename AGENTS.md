...
## Repository Shape
- This repository is a single-module `Gradle + Java 17 + Forge` codebase.
- Keep that shape during the refactor unless a human explicitly asks for a module split.
...
## Generated Code
- Treat `src/main/java/io/github/tt432/eyelib/molang/generated/` as generated/read-only during normal work.
