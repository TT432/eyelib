...
public record Element(
    ...
    public static final Codec<Element> CODEC = RecordCodecBuilder.create(ins -> ins.group(
            ...
            BbModelCodecs.FLOATS2VEC3F_CODEC.fieldOf("from").forGetter(Element::from),
            BbModelCodecs.FLOATS2VEC3F_CODEC.fieldOf("to").forGetter(Element::to),
            Codec.INT.fieldOf("autouv").forGetter(Element::autouv),
            Codec.INT.fieldOf("color").forGetter(Element::color),
            BbModelCodecs.FLOATS2VEC3F_CODEC.fieldOf("origin").forGetter(Element::origin),
            BbModelCodecs.FLOATS2VEC2F_CODEC.optionalFieldOf("uv_offset", new Vector2f()).forGetter(Element::uvOffset),
            ...
            BbModelCodecs.FLOATS2VEC3F_CODEC.optionalFieldOf("rotation", new Vector3f()).forGetter(Element::rotation)
