...
- Added `eyelib-preprocessing/src/main/java/io/github/tt432/eyelibpreprocessing/loader/LoaderParsingOps.java` as a pure decode/translation helper for codec-based loader parsing.
...
- Added targeted seam test: `eyelib-preprocessing/src/test/java/io/github/tt432/eyelibpreprocessing/loader/LoaderParsingOpsTest.java`.

## JetBrains MCP verification results
- Targeted test run (`./gradlew :eyelib-preprocessing:test --tests io.github.tt432.eyelibpreprocessing.loader.LoaderParsingOpsTest`): **PASS**.
...
- `LoaderParsingOps` and its tests are now platform-type-free for key translation contracts (no `ResourceLocation` in method signatures) and now live in `:eyelib-preprocessing`.
