package io.github.tt432.eyelibprocessor.manager.reload;
...
class ManagerResourceReloadPlanTest {
    ...
    void classifySingleFileRoutesKnownJsonFolders() {
        ...
        assertEquals(ManagerResourceReloadPlan.ReloadTarget.ATTACHABLE_JSON,
                ManagerResourceReloadPlan.classifySingleFile("attachables/a.json"));
    ...
    void classifySingleFileHandlesModelAndTextureFiles() {
        ...
        assertEquals(ManagerResourceReloadPlan.ReloadTarget.MATERIAL_FILE,
                ManagerResourceReloadPlan.classifySingleFile("materials/a.material"));
