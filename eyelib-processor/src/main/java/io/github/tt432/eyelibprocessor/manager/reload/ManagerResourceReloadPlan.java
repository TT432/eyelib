...
public final class ManagerResourceReloadPlan {
    ...
    public static ReloadTarget classifySingleFile(String relativePath) {
        ...
        if (normalizedRelativePath.endsWith(".json")) {
            ...
            if (normalizedRelativePath.startsWith("attachables/")) {
                return ReloadTarget.ATTACHABLE_JSON;
            }
        ...
        if (normalizedRelativePath.startsWith("materials/") && normalizedRelativePath.endsWith(".material")) {
            return ReloadTarget.MATERIAL_FILE;
        }
