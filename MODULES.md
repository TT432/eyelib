...
| eyelib-material subproject | Bedrock material definitions, GL state management, and shader pipeline | `eyelib-material/build.gradle`, `eyelib-material/src/main/java/io/github/tt432/eyelibmaterial/` | consumed by root render controllers, particle renderer; depends on no other eyelib subprojects |
